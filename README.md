...
На вкладках после извлечения доступны вкладки анализа графа и его выгрузки/загрузки. В качестве примера добавленного графа надо загрузить файл `neo4j_graph_export.json`
